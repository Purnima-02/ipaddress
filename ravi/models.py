...
class ApplicationVerification(models.Model):
    personal_detail = models.OneToOneField(PersonalDetail, on_delete=models.CASCADE, related_name='application_verification') 
...
class pldisbursementdetails(models.Model):
    verification = models.OneToOneField(ApplicationVerification, on_delete=models.CASCADE, blank=True, related_name='pldisbursement_detail', default='')
...
class CustomerProfile(models.Model):
    ...
    co_applicant_age = models.DateField(max_length=2, validators=[validate_age])
