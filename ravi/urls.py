...
urlpatterns = [
    ...
    # Basic Detail Views
    path('basicdetail/', views.basicdetailspl, name='personalbasicdetail'),
  ...
  # Home basic detail
    ...
    path('disbursement-summary/', views.hldisbursement_summary, name='hldisbursement_summary'),#disbursement-summary
